...
@section('content')
    ...
    @can('create-users')
        <div class='col-md-12 text-center'>
            <a href='{{route('users.create')}}' alt='New' title='New' class='btn btn-default'>
                New
            </a>
            <br/>
            <br/>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" {{$checked}} class='checkboxActive' data-model="User" data-id="{{$user->id}}" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Active" data-off="Inactive" >
                </td>
            </tr>
            @empty
            <tr>
